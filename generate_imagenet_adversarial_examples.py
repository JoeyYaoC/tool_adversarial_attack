...
```bash
python3 /home/czw/yczy/tool_adversarial/generate_imagenet_adversarial_examples.py \
  --model-type resnet50 \
...
def main() -> None:
    ...
    with manifest_path.open("w", encoding="utf-8") as manifest_file:
        for raw_batch in dataloader:
            ...
            if args.targeted and args.target_mode == "fixed" and args.fixed_target_label is not None:
                eligible_mask = eligible_mask & (labels != args.fixed_target_label)
